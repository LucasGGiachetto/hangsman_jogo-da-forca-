const listaPalavras = ['computador', 'teclado', 'monitor', 'internet',
    'programacao', 'algoritmo','bicicleta', 'paralelepipedo', 'xícara', 'xadrez',
    'abacaxi', 'elefante', 'girassol', 'arara',
    'lanterna', 'ventilador', 'biblioteca', 'queijo',
    'esfinge', 'tartaruga', 'plástico', 'música',
    'fone', 'tecnologia'];
